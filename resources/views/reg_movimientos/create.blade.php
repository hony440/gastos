...
@section('content')
<script src="{{asset('js/reg_movimientos.js')}}"></script>

	<form action="{{route('reg_movimientos.store')}}" method="POST" onsubmit="return validar()">
			@csrf
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<input type="text" name="mov_cantidad" id="mov_cantidad">
					</div>
