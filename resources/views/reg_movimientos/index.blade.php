...
<tr>
	  ...
	  <td>  
	  	<div class="row">
	  	<a href="{{route('reg_movimientos.edit',$m->mov_id)}}"  class="btn btn-primary"  >Editar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
